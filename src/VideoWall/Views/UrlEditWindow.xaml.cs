    ...
    public partial class UrlEditWindow : Window
    {
        ...
        private async void OnLoaded(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                ...
                // Desliga o overlay de vídeo por hardware (vídeo renderizava PRETO em
                // notebook/TV) e deixa a live tocar sozinha. Opções explícitas garantem
                // que valham nesta janela (ela cria o ambiente com pasta própria).
